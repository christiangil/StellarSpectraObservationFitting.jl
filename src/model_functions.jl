...
# function spectra_interp(stellar_model_flux, model_log_λ::AbstractVector{<:Real}, rvs, log_λ_obs::AbstractMatrix, lower_inds::AbstractMatrix, lower_inds2::AbstractMatrix)
# 	log_λ_bary = log_λ_obs .+ rv_to_D(rvs)'
# 	x0 = view(model_log_λ, lower_inds)
# 	x1 = view(model_log_λ, lower_inds .+ 1)
